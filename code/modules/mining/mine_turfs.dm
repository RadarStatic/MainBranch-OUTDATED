...
/turf/simulated/mineral/random
	...
	var/mineralSpawnChanceList = list("Uranium" = 10, "Diamond" = 5, "Gold" = 20, "Silver" = 24, "Plasma" = 30, "Iron" = 40, "Gibtonite" = 4/*, "Adamantine" =5*/, "Cave" = 2)//Currently, Adamantine won't spawn as it has no uses. -Durandan
