	...
	switch(screenstate)
		...
		if(1)
			...
			if(!dbcon.IsConnected())
				...
				dat += "<table border=\"1\">"
				dat += "<tr><th>AUTHOR</th><th>TITLE</th><th>CATEGORY</th><th>SS<sup>13</sup>BN</th></tr>"
	...
	switch(screenstate)
		...
		if(4)
			...
			if(!dbcon.IsConnected())
				...
				dat += "<table border=\"1\">"
				dat += "<tr><th>AUTHOR</th><th>TITLE</th><th>CATEGORY</th><th>SS<sup>13</sup>BN</th><th>ORDER</th></tr>"
