...
/obj/item/weapon/storage/backpack/satchel
	...
	New()
		..()
		if(config&&config.narkyspooky)
			icon_state="candypumpkin"
			color="#"+pick("88","ff")+pick("88","ff")+pick("88","ff")

			var/candy_to_put=pick(/obj/item/weapon/reagent_containers/food/snacks/candiedapple,
			/obj/item/weapon/reagent_containers/food/snacks/spacetwinkie,
			/obj/item/weapon/reagent_containers/food/snacks/candy_corn,
			/obj/item/weapon/reagent_containers/food/snacks/candy)

			if(istype(src,/obj/item/weapon/storage/backpack/satchel_med)||prob(5))
				candy_to_put=pick(/obj/item/weapon/reagent_containers/food/snacks/egg,
				/obj/item/weapon/reagent_containers/food/snacks/tofu,
				/obj/item/weapon/reagent_containers/food/snacks/grown/apple)

			new candy_to_put(src)
