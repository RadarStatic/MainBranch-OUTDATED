...
/obj/machinery/computer/slot_machine/proc/give_prizes(usrname, mob/user)
	...
	if(reels[1][2] + reels[2][2] + reels[3][2] + reels[4][2] + reels[5][2] == "[SEVEN][SEVEN][SEVEN][SEVEN][SEVEN]")
		...
		if(prob(2)&&has_toaster)
			visible_message("<b>[src]</b> says, 'Hey! Down on your luck? Have a free consolation toaster!'")
			has_toaster=0
			var/obj/item/toy/toaster/T = new /obj/item/toy/toaster(loc)
			T.throw_at(user, 3, 10)
